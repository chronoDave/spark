type Child = string | number | boolean | null | (() => Child);
...
type Component<T extends object = {}> = (props: T & {
    children?: Child[];
}) => string;
declare const createElement: (tag: string | Component, props: object | null, ...children: Child[] | Child[][]) => string;

export { type Component, JSX, createElement };
