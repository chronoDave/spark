...
test('[spark] renders attributes', t => {
  ...
  t.assert.equal(h('span')({ 'aria-hidden': true })(), '<span aria-hidden></span>', 'renders boolean true attribute');
  ...
  t.assert.equal(h('span')({ 'aria-hidden': false })(), '<span></span>', 'does not render boolean false attribute');
...
test('[spark] renders children', t => {
  ...
  t.assert.equal(h('div')({})(true), '<div></div>', 'does not render boolean true child');
...
test('[spark.xml] renders attributes', t => {
  ...
  t.assert.equal(xml('name')({ 'aria-hidden': true })(), '<name aria-hidden/>', 'renders boolean true attribute');
  ...
  t.assert.equal(xml('name')({ 'aria-hidden': false })(), '<name/>', 'does not render boolean false attribute');
...
test('[spark.xml] renders children', t => {
  ...
  t.assert.equal(xml('name')({})(true), '<name/>', 'does not render boolean true child');
